...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "C:\\Users\\berna\\PycharmProjects\\GOOGLE_API_DATA\\client_secrets.json"
project_id = '864217702572' # Your Google Cloud project ID.
pkey = 'client_secrets.json' # see readme for help with creating the credentials and .json key.
my_table = 'raw_googlesearchconsole.data' # see notes in the readme with regard to creating this table before running the script.
